...
@section('content')
    <h1 class="app-page-title">Gestion des Employés.</h1>
    <hr class="mb-4">
    <div class="row g-4 settings-section">
        <div class="col-12 col-md-4">
            <h3 class="section-title">Ajouter Employé</h3>
            <div class="section-intro">Formulaire d'Enregistrement des Employés.</div>
        </div>
        <div class="col-12 col-md-8">
            <div class="app-card app-card-settings shadow-sm p-4">

                <div class="app-card-body">
                    <form class="settings-form" method="POST" action="{{ route('employes.store') }}"> @csrf
                        @method('POST')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-1" value="{{ old('prenom') }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-2" value="{{ old('nom') }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="setting-input-3" value="{{ old('telephone')}}" placeholder="77 000 00 00"
                                name="telephone">
                            @error('telephone')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="setting-input-3" value="{{ old('montant_journalier')}}" placeholder="1000 FCFA"
