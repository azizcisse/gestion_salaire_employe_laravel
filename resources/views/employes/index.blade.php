        ...
        <div class="col-auto">
            <div class="page-utilities">
                <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                    ...
                    <div class="col-auto">
                        <a class="btn app-btn-secondary" href="{{ route('employes.create_employe') }}">
                            ...
                            <tbody>
                                @forelse ($employes as $employe)
                                    <tr>
                                        ...
                                        <td class="cell">{{ $employe->departement->nom_departement }}</td>
                                        <td class="cell">{{ $employe->prenom }}</td>
                                        <td class="cell">{{ $employe->nom }}</td>
                                        <td class="cell">{{ $employe->email }}</td>
                                        <td class="cell">{{ $employe->telephone }}</td>
                                        <td class="cell"><span class="badge bg-success">
                                                {{ $employe->montant_journalier * 30 }} FCFA</span>
                                        </td>
                                        <td class="cell">
                                            <a class="btn btn-secondary"
                                                href="{{ route('employes.edit_employe', $employe->id) }}">Editer</a>
                                            <a class="btn btn-danger"
                                                href="{{ route('employes.delete', $employe->id) }}">Supprimer</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
